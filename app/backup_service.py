...
def effective_setting_values(db: Session) -> dict[str, str]:
    ...
    return {
        ...
        "notification_bark_encryption_enabled": _bool_text(notifications.bark_encryption_enabled),
        "notification_bark_encryption_algorithm": notifications.bark_encryption_algorithm,
        "notification_bark_encryption_mode": notifications.bark_encryption_mode,
        "notification_bark_encryption_padding": notifications.bark_encryption_padding,
