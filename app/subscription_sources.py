...
_SOURCES: tuple[SubscriptionSource, ...] = (
    ...
    SubscriptionSource(
        ...
        label="Nyaa",
        short_label="Nyaa",
        description="使用统一番剧周历选择作品，并生成 Nyaa 动画分类的关键词 RSS。",
        rss_name="Nyaa",
        placeholder="https://nyaa.si/?page=rss&q=...&c=1_2&f=0",
        default_feed_url="",
        official_url="https://nyaa.si",
        help_url="https://nyaa.si",
        hosts=("nyaa.si",),
        catalog_view="add-catalog",
        caution="Nyaa 主要使用英文或日文标题搜索；请根据当地法律和站点规则使用。",
    ),
    SubscriptionSource(
        id="subsplease",
        label="SubsPlease",
        short_label="SubsPlease",
        description="使用统一番剧周历选择作品，并从 SubsPlease 官方分辨率 RSS 中按标题过滤。",
        rss_name="SubsPlease",
        placeholder="https://subsplease.org/rss/?r=1080&t=",
        default_feed_url="https://subsplease.org/rss/?r=1080&t=",
        official_url="https://subsplease.org",
        help_url="https://subsplease.org/rss-feeds/",
        hosts=("subsplease.org",),
        catalog_view="add-catalog",
        caution="SubsPlease RSS 是全站分辨率流，FeedDock 会自动添加标题匹配规则。",
    ),
    SubscriptionSource(
        id="other",
        label="其它 RSS",
